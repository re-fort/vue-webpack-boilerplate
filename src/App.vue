  ...
  #app
    section.hero.is-primary
      .hero-head
        ...
        a.github-corner(:href="$store.state.authUrl")
          svg(width="54" height="54" viewBox="0 0 250 250" style="fill:#fff; color:#00d1b2; position: absolute; top: 0; border: 0; right: 0;")
